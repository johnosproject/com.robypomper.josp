...
@RestController
@RequestMapping(JCPAPIsGroups.PATH_CONF)
@Api(tags = {JCPAPIsGroups.API_CONF_SG_PLACEHOLDER_NAME})
public class ConfigsController {
    ...
    public String getPublic() {
        return "Configs is up and running";
    }
    ...
    public String getPrivate() {
        return "Configs is up, running and private";
    }
    ...
    public String getRoleObj() {
        return String.format("Configs is up, running and protected (role: %s)", SwaggerConfigurer.ROLE_OBJ);
    }
