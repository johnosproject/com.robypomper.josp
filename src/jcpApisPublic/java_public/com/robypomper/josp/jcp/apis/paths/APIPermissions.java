...
//@formatter:off
    ...
    public static final String PATH_OBJOWNER_IS     = "/" + version + "/obj/owner";
    ...
    public static final String FULL_PATH_OBJOWNER_IS    = FULL_PATH_BASE + PATH_OBJOWNER_IS;
    ...
    public static final String URL_PATH_OBJOWNER_IS     = URL_PATH_BASE + PATH_OBJOWNER_IS;
