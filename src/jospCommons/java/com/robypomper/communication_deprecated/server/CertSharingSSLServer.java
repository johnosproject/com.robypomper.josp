...
import com.robypomper.communication_deprecated.server.standard.SSLCertServer;
...
public class CertSharingSSLServer implements Server {
    ...
    public CertSharingSSLServer(String serverId, int port,
        ...
        heartBeat.setWrapped(sslServer.getHeartBeatConfigs());
    ...
    public Date getLastStartup() {
        return sslServer.getLastStartup();
    }
    ...
    public Date getLastShutdown() {
        return sslServer.getLastShutdown();
    }
    ...
    public Date getLastClientConnection() {
        return sslServer.getLastClientConnection();
    }
    ...
    public ClientInfo getLastClientConnectionClient() {
        return sslServer.getLastClientConnectionClient();
    }
    ...
    public Date getLastClientDisconnection() {
        return sslServer.getLastClientDisconnection();
    }
    ...
    public ClientInfo getLastClientDisconnectionClient() {
        return sslServer.getLastClientDisconnectionClient();
    }
    ...
    public Date getLastHeartbeat() {
        return sslServer.getLastHeartbeat();
    }
    ...
    public ClientInfo getLastHeartbeatClient() {
        return sslServer.getLastHeartbeatClient();
    }
    ...
    public Date getLastHeartbeatFailed() {
        return sslServer.getLastHeartbeatFailed();
    }
    ...
    public ClientInfo getLastHeartbeatClientFailed() {
        return sslServer.getLastHeartbeatClientFailed();
    }
    ...
    public Date getLastDataReceived() {
        return sslServer.getLastDataReceived();
    }
    ...
    public ClientInfo getLastDataReceivedClient() {
        return sslServer.getLastDataReceivedClient();
    }
    ...
    public Date getLastDataSend() {
        return sslServer.getLastDataSend();
    }
    ...
    public ClientInfo getLastDataSendClient() {
        return sslServer.getLastDataSendClient();
    }
