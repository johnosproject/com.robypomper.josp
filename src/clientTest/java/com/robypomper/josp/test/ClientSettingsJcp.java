...
public class ClientSettingsJcp extends ClientSettings {
    ...
    private static final Pair<String, String> CLIENT_ID_API = new Pair<>("test-client-api", "20e3f807-f2f8-427d-a048-2462c63bac7f");
    ...
    public static Pair<String, String> findClientCredentials(String cliCredName) {
        ...
        if (cliCredName.compareToIgnoreCase(AUTH_REALM + "-" + CLIENT_ID_API.getKey()) == 0) return CLIENT_ID_API;
        return null;
    }
