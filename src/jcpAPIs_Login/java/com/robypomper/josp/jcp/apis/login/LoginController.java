...
@RestController
@RequestMapping(JCPAPIsGroups.PATH_LOGIN)
@Api(tags = {JCPAPIsGroups.API_LOGIN_SG_PLACEHOLDER_NAME})
public class LoginController {
    ...
    public String getPublic() {
        return "Login is up and running";
    }
    ...
    public String getPrivate() {
        return "Login is up, running and private";
    }
    ...
    public String getRoleObj() {
        return String.format("Login is up, running and protected (role: %s)", SwaggerConfigurer.ROLE_OBJ);
    }
