...
@Api(tags = {JCPAPIsGroups.API_USRS_SG_PLACEHOLDER_NAME})
public class UserController {
    ...
    public String getPrivate() {
        return "User is up, running and private";
    }
    ...
    public String getRoleObj() {
        return String.format("User is up, running and protected (role: %s)", SwaggerConfigurer.ROLE_OBJ);
    }
