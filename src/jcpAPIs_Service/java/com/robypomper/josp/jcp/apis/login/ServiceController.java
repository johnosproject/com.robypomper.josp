...
@RestController
@RequestMapping(JCPAPIsGroups.PATH_SRVS)
@Api(tags = {JCPAPIsGroups.API_SRVS_SG_PLACEHOLDER_NAME})
public class ServiceController {
    ...
    public String getPrivate() {
        return "Service is up, running and private";
    }
    ...
    public String getRoleObj() {
        return String.format("Service is up, running and protected (role: %s)", SwaggerConfigurer.ROLE_OBJ);
    }
