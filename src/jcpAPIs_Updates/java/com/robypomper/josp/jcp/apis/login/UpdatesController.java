...
@RestController
@RequestMapping(JCPAPIsGroups.PATH_UPDS)
@Api(tags = {JCPAPIsGroups.API_UPDS_SG_PLACEHOLDER_NAME})
public class UpdatesController {
    ...
    public String getPublic() {
        return "Updates is up and running";
    }
    ...
    public String getPrivate() {
        return "Updates is up, running and private";
    }
    ...
    public String getRoleObj() {
        return String.format("Updates is up, running and protected (role: %s)", SwaggerConfigurer.ROLE_OBJ);
    }
