...
@RestController
@RequestMapping(JCPAPIsGroups.PATH_JGWS)
@Api(tags = {JCPAPIsGroups.API_JGWS_SG_PLACEHOLDER_NAME})
public class JOSPGWsController {
    ...
    public String getPublic() {
        return "JOSPGWs is up and running";
    }
    ...
    public String getPrivate() {
        return "JOSPGWs is up, running and private";
    }
    ...
    public String getRoleObj() {
        return String.format("JOSPGWs is up, running and protected (role: %s)", SwaggerConfigurer.ROLE_OBJ);
    }
