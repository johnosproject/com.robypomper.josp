...
public class JODRangeAction extends JODRangeState implements JODAction {
     ...
     */
    public JODRangeAction(JODStructure structure, JODExecutorMngr execMngr, String name, String descr, String listener, String puller, String executor, Double min, Double max, Double step) throws JODStructure.ComponentInitException {
        super(structure, execMngr, name, descr, listener, puller, min, max, step);
