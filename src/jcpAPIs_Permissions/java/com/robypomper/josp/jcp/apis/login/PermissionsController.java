...
@RestController
@RequestMapping(JCPAPIsGroups.PATH_PERM)
@Api(tags = {JCPAPIsGroups.API_PERM_SG_PLACEHOLDER_NAME})
public class PermissionsController {
    ...
    public String getPublic() {
        return "Permissions is up and running";
    }
    ...
    public String getPrivate() {
        return "Permissions is up, running and private";
    }
    ...
    public String getRoleObj() {
        return String.format("Permissions is up, running and protected (role: %s)", SwaggerConfigurer.ROLE_OBJ);
    }
