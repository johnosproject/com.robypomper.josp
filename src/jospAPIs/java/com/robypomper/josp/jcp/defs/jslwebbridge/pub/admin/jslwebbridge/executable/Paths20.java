...
public class Paths20 extends com.robypomper.josp.defs.admin.jslwebbridge.executable.Paths20 {
    ...
    public static final String FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_JAVA_THREADS     = API_PATH + "/" + API_VER + "/" + MTHD_EXEC_JAVA_THREAD;
    public static final String FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_JAVA_THREAD      = API_PATH + "/" + API_VER + "/" + MTHD_EXEC_JAVA_THREADS;
    ...
    //@formatter:off
    // JCP JSL Web Bridge Executable methods
    public static String FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_JAVA_THREAD         (long threadId){ return FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_JAVA_THREAD      .replace(PARAM_THREAD,Long.toString(threadId)); }
    public static String FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_DISK                (String diskId){ return FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_DISK             .replace(PARAM_DISK,diskId); }
    public static String FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_NETWORK             (int networkId){ return FULL_PATH_JSLWB_ADMIN_JSLWB_EXEC_NETWORK          .replace(PARAM_NTWK,Integer.toString(networkId)); }
    //@formatter:off
