...
public class Paths20 extends com.robypomper.josp.jcp.defs.base.internal.status.executable.Paths20 {
    ...
    //@formatter:off
    // Java
    public static String FULL_PATH_JCP_APIS_EXEC_JAVA_THREAD         (long threadId){ return FULL_PATH_JCP_APIS_EXEC_JAVA_THREAD      .replace(PARAM_THREAD,Long.toString(threadId)); }
    // Disks
    public static String FULL_PATH_JCP_APIS_EXEC_DISK                (String diskId){ return FULL_PATH_JCP_APIS_EXEC_DISK             .replace(PARAM_DISK,diskId); }
    // Networks
    public static String FULL_PATH_JCP_APIS_EXEC_NETWORK             (int networkId){ return FULL_PATH_JCP_APIS_EXEC_NETWORK          .replace(PARAM_NTWK,Integer.toString(networkId)); }
    //@formatter:off
